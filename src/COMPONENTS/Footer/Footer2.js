...
const Footer2 = () => {
    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
            ...
            <p>Fit Grocery is a leading online grocery store in the India. We are committed to providing the best quality products at the best prices.</p>
        ...
        <h3>
            Subscribe Now
              ...
              <p>Subscribe your email for newsletter and feature news based on your interest</p>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
      ...
      <div className='footerin2'>
        ...
        <h2>
        <h3>Contact Us on: </h3>
        <h3>WhatsApp No. 1122334455 </h3>
        <h3>Call No. 2222444400 </h3>
        <h3>Timing 8:00 Am To 8:00 Pm (365Days)</h3></h2>
      </div>
    </div>
  )
}
